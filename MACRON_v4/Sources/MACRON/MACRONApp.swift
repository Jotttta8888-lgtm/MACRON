...
class AppDelegate: NSObject, NSApplicationDelegate {
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        HealthTrackerService.shared.load()
        LearningModeService.shared.load()
        RecipeManagerService.shared.load()
        SmartHomeScenesService.shared.load()
        ThemeStudioService.shared.load()
        SoundboardService.shared.load()
        PackageTrackerService.shared.load()
        GameLauncherService.shared.load()
        TagSystemService.shared.load()
        NotificationRulesService.shared.load()
        TravelPlannerService.shared.load()
